...
void RegisterUser (string &usernameregis, string &passwordregis, int &jumlahUser, LoginUser user[], int &id_user, string &namebaru, string &passbaru){
    cout <<"Masukan USERNAME: "; getline (cin, namebaru);
    cout <<"Masukan PASSWORD: "; getline (cin, passbaru);
    if (Registrasi(usernameregis, passwordregis, jumlahUser, user, id_user)){
        cout << "Registrasi Berhasil ✅\n";
    }
}
int login_User_Admin(string username, string &password, int &jumlahUser, Login admin ,LoginUser user[], int &id_user, string &inputname, string &inputpass, int &loginawal){
    ...
    while (true){
        ...
        if (pilihMenu == 1){
            ...
            while (loginawal < 3){
                ...
                int Kategori = login_User_Admin(username, password , jumlahUser, admin, user, id_user, inputname, inputpass, loginawal);
                if (Kategori == 1) {
                    ...
                    while(true){
                        ...
                        cout <<"                   Menu ADMIN                  \n";
                        cout <<"===============================================\n";
                        cout <<"1. Lihat Blink Ranking Musik\n";
            ...
            cout <<"Masukan USERNAME Baru: "; getline (cin, usernameregis);
            cout <<"Masukan PASSWORD Baru: "; getline (cin, passwordregis);
